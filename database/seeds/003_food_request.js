...
exports.seed = async (knex) => {
  ...
  await knex("users").insert([
    ...
    { id: 6, type: "Bread", amount_servings: 40, pickup_time: 1581758014, description: "Describe food to be picked up.", completed: false, business_id: 9, volunteer_id: 2 },
    { id: 7, type: "Dessert", amount_servings: 16, pickup_time: 1581671614, description: "Describe food to be picked up.", completed: false, business_id: 9, volunteer_id: 4 },
